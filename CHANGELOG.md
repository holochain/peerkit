...
## \[[0.0.0-alpha.1](https://github.com/holochain/peerkit/commits/v0.0.0-alpha.1)\] - 2026-05-20
...
- Use build:dist instead of build in publish workflow
- Rename label back to release
- Replace release-it bumper with npm version --workspaces, drop release-it dep
- Install git-cliff via taiki-e/install-action for PATH availability
- Install git-cliff to PATH via gh release download
- Rename release label to release-it
- Use HRA2_GITHUB_TOKEN for PR creation
- Use git-cliff binary directly, add PAT for team reviewers
- Fixup! ci: add release-it config and automated release workflows
- Fixup! ci: add release-it config and automated release workflows
- Fixup! ci: add release-it config and automated release workflows
- Fixup! ci: add release-it config and automated release workflows
- Fixup! ci: add release-it config and automated release workflows
...
- Update lockfile for release-it dependencies
- Mark @peerkit/transport-libp2p-react-native as private
...
- Add release-it config and automated release workflows
...
- Hardcode 0.0.0-alpha.1 for push trigger, add empty version guard
...
- @synchwire made their first contribution in [#28](https://github.com/holochain/peerkit/pull/28)
